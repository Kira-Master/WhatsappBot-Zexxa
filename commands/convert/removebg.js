...
module.exports = {
    ...
    callback: async ({ msg, client, message }) => {
        ...
        if (msg.typeCheck.isImage || msg.typeCheck.isQuotedImage) {
            ...
            client.sendMessage(msg.from, { document: { url: `https://xzn.wtf/api/removebg?url=${file}&apikey=zexxabot` }, mimetype: 'image/png', fileName: 'Removebg.png' }, { quoted: message }).catch(() => { return msg.reply('Terjadi kesalahan') })
